...
/// UI dialog types (Dependency Inversion, mirroring <see cref="ICredentialPrompt"/>). The
...
public interface IExportFileDialog
{
    ...
    Task<ExportTarget?> PickSaveTargetAsync(IReadOnlyList<IHistoryExporter> formats, string suggestedFileName);
}
